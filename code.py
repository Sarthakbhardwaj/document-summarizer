// this code gives us objects and their relations, it also reduces the redundant relations that have been formed(filtering) 
...
Maggie Chartier, MPH, MS, Ann Vander Stoep, PhD., Elizabeth McCauley, PhD., Jerald R. Herting, PhD, Melissa Tracy, BA, and James Lymp, PhD. "Passive Versus Active Parental Consent: Implications for the Ability of School-based Depression Screening to Reach Youth at Risk." Journal of School Health. March 2008; 78(3): 157-168.'''
    print('Text: %s.' % text)
